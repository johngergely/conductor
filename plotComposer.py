...
from streamManagers import streamSimulator
...
class plotManager():
    ...
    def setLifetime(self, T0, Tend):
        self.T0 = T0
        self.Tend = Tend
        print "plotManager::::::::::(times in secs)"
        print "Trip data time range",self.T0,self.Tend
    ...
    def run(self):
        ...
        while self.clock < self.Tend:
            ...
            print self.clock, "[",self.T0,self.Tend,"] update DF"
